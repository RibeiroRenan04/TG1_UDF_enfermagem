...
/// <summary>Presença de dia remoto, comprovada pelo código e, se exigida, pela tarefa entregue.</summary>
public class RemoteActivity
{
    ...
    /// <summary>Encerrada manualmente: invalida o código antes do fim da janela.</summary>
    ...
    /// <summary>O alfabeto exclui 0/O e 1/I, que o aluno confunde ao digitar.</summary>
